...
class JournalEntry extends Model
{
    ...
    protected function casts(): array { return ['date'=>'date','total_debit'=>'decimal:2','total_credit'=>'decimal:2','posted_at'=>'datetime','reversed_at'=>'datetime']; }
    ...
    public function getStatusLabelAttribute(): string { return ['draft'=>'Borrador','posted'=>'Contabilizado','reversed'=>'Reversado'][$this->status] ?? $this->status; }
}
