...
const props = defineProps({ clients: Object, filters: Object, endpoints: Object });
...
<template>
    <AppLayout title="Historial crediticio" eyebrow="Crédito" description="Créditos de cada cliente, historial de pagos y desbloqueo de un nuevo crédito al cancelar el vigente.">
        <div class="space-y-4">
