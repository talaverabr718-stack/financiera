...
$map=[
 ...
 'cancelled'=>['Cancelado','bg-slate-100 text-slate-600'],'inactive'=>['Inactivo','bg-slate-100 text-slate-600'],'released'=>['Liberado','bg-slate-100 text-slate-600'],'draft'=>['Borrador','bg-slate-100 text-slate-600'],'current'=>['Al día','bg-emerald-50 text-emerald-700'],'resolved'=>['Resuelto','bg-emerald-50 text-emerald-700'],
