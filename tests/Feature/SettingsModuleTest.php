...
class SettingsModuleTest extends TestCase
{
    ...
    {
        $user=User::factory()->create(); $module=SystemModule::where('key','reports')->firstOrFail();
    ...
    public function test_system_name_and_logo_are_saved_and_rendered(): void
    {
        ...
        $this->assertNotSame($path,$newPath); Storage::disk('local')->assertMissing($path); Storage::disk('local')->assertExists($newPath);
    }
